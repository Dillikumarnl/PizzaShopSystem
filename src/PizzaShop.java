public class PizzaShop {
    public static void main(String[] args) {
        // Create a customer
        Customer customer = new Customer("John Kumar", "1","1234567890", new Address("NY", "Washington", "342456","123, Street"));
        ...
        Pizza pizza2 = new Cheese(new Cheese(new PepperoniPizza(PizzaSize.LARGE, PizzaCrust.THICK)));  // Double Cheese Pepperoni
